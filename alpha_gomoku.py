...
def train():
    ...
    game = Gomoku(game_board_width)
    policy = policy_network(input_dim=game.nn_input.shape, output_dim=game.w**2)
    print("policy_net:", policy_network)
    ...
    for i in range(game_episode_num):
        ...
        for _ in range(selfplay_batch_size):
            ...
            """    print("play_data:",type(play_data))
            print("states:", type(play_data[0]))
            print("len_states:", len(play_data[0]))
            print(play_data[0][0])
            print("pi:", type(play_data[1]))
            print("len_pi:", len(play_data[1]))
            print(play_data[1][0])
            print("reward:", type(play_data[2]))
            print("len_reward:", len(play_data[2]))
            print(play_data[2][0])"""
        ...
        if len(data_buffer) > train_batch_size:
            ...
            print("state_batch:", policy.pred(state_batch))
